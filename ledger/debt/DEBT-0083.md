# DEBT-0083 — No Evidence Submitted to Court MCP

Status: **OPEN** · Filed: 2026-08-07 · Channel: CER-3
Level: **runtime** (autonomous friction detection, RB-0008).
Source: Autonomous run — goal `g-a4bc1c1a20c1`.

## 1. Observation

During autonomous execution, goal `g-a4bc1c1a20c1` encountered friction:
`no evidence submitted to the court for this run`.

Implicated paths: `runtime/`, `sakg/`, `tests/`, `tests/sakg/`.

## 2. Leverage Assessment (RB-0008 Primitive 4)

**Leverage: 3.0x** (below immediate-queue threshold). Substrate: yes. Recurring: no. Blast radius: SOFT.
