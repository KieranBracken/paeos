# DEBT-0095 — No Evidence Submitted to Court MCP

Status: **OPEN** · Filed: 2026-08-07 · Channel: CER-3
Level: **runtime** (autonomous friction detection, RB-0008).
Source: Autonomous run — goal `g-381243615d44`.

## 1. Observation

During autonomous execution, goal `g-381243615d44` encountered friction:
`no evidence submitted to the court for this run`.

Implicated paths: `sakg/`, `tests/`, `tests/sakg/`.
