# DEBT-0090 — No Evidence Submitted to Court MCP

Status: **OPEN** · Filed: 2026-08-07 · Channel: CER-3
Level: **runtime** (autonomous friction detection, RB-0008).
Source: Autonomous run — goal `g-cd89e2c0b3eb`.

## 1. Observation

During autonomous execution, goal `g-cd89e2c0b3eb` encountered friction:
`no evidence submitted to the court for this run`.

Implicated paths: `ledger/`, `tests/sakg/`.
